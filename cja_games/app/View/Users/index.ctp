<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('confirm_password'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['confirm_password']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['mailing_address']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['register_date']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['activate']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $user['User']['id'],$user['User']['username']), null, __('Are you sure you want to delete # %s?', $user['User']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
